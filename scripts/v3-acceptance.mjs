...
const products = [
  { id: 'bolt-obj', handle: 'dojo-bolt-gen-v05-obj', title: 'Dojo Bolt Gen V05_Obj', description: 'The drag-and-drop object edition of the Dojo Bolt Generator, pre-configured with live parametric controls.', price: '7.77', product_type: 'Geometry Nodes', tags: ['Geometry', 'Object edition'], release_status: 'stable', release_version: '05.3', presentation: { mode: 'flagship' }, image: '/v3/assets/dojo-bolt-disassembly.gif', thumbnail_image: '/assets/product-images/icon_Dojo Bolt Gen v05_Obj.png' },
  { id: 'bolt', handle: 'dojo-bolt-gen-v05', title: 'Dojo Bolt Gen V05', description: 'A live Geometry Nodes tool for printable bolts.', price: '7.77', product_type: 'Geometry Nodes', tags: ['Geometry', 'Node edition'], release_status: 'stable', release_version: '05.3', presentation: { mode: 'flagship' }, image: '/assets/product-images/Dojo Bolt Gen v05.gif', thumbnail_image: '/assets/product-images/icon_Dojo Bolt Gen v05.png' },
  { id: 'knob', handle: 'dojo-knob', title: 'Dojo Knob', description: 'A flexible parametric knob generator.', price: '7.77', product_type: 'Geometry Nodes', tags: ['Geometry', 'Generator'], release_status: 'stable', presentation: { mode: 'flagship' }, image: '/assets/product-images/Dojo Knob.gif', thumbnail_image: '/assets/product-images/icon_Dojo Knob.png' },
  { id: 'chrome', handle: 'chrome-crayon', title: 'Chrome Crayon', description: 'A linked-form generator for procedural chain studies.', price: '', product_type: 'Geometry Nodes', tags: ['Geometry', 'Generator'], release_status: 'stable', presentation: { mode: 'flagship' }, image: '/assets/product-images/icon_Dojo Crv Wrapper v4.png', thumbnail_image: '/assets/product-images/icon_Dojo Crv Wrapper v4.png' },
